...
#define SD_DISK_IV_SIZE			2048
#define E4M_DISK_IV_SIZE		32

#if E4M_DISK_IV > SD_DISK_IV
#define MAX_DISK_IV E4M_DISK_IV_SIZE
#else
#define MAX_DISK_IV SD_DISK_IV_SIZE
#endif
...
#define TEA_KS				(16+4)	/* (includes 4 for # of
						   rounds) */
#define SQUARE_KS			144
#define MISTY1_KS			128
#define CAST_KS				128
...
{\
	...
	else if (cipher == TEA16 || cipher == TEA32) teadecipher ((void *) data, (void *) ks); \
	...
	else if (cipher == SQUARE) squareDecrypt ((void *) data, (void *) ((char *) ks + SQUARE_KS)); \
	else if (cipher == MISTY1) misty1_decrypt_block ((void *) ks, (void *) data,(void *)  data);  \
...
{\
	...
	else if (cipher == TEA16 || cipher == TEA32) teaencipher ((void *) data, (void *) ks); \
	else if (cipher == IDEA) ideaCrypt ((void *) data, (void *) data, (void *) ks); \
	else if (cipher == DES56) des_encrypt ((void *) data, (void *) ks, 1); \
	else if (cipher == SQUARE) squareEncrypt ((void *) data,(void *)  ks); \
	else if (cipher == MISTY1) misty1_encrypt_block ((void *) ks, (void *) data, (void *) data); \
...
{\
	...
	else if (cipher == TEA16) inittea ((void*) key, (void*)ks, 16); \
	else if (cipher == TEA32) inittea ((void*) key, (void*)ks, 32); \
	...
	else if (cipher == SQUARE) squareinitialise ((void*)key,(void*)ks); \
	else if (cipher == MISTY1) misty1_keyinit ((void*)ks, (void*) &key); \
...
#define init_sd_cipher(cipher, keylen, key, ks) \
	if (cipher == BLOWFISH) BF_set_key ((void*)ks, keylen, (void*) key); \
	else init_cipher(cipher, key, ks)
