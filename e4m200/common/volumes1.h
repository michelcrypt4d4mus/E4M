...
void _cdecl EncryptSector ( unsigned long *data , unsigned long secNo , unsigned long noSectors , unsigned char *auxKey , char *iv , int cipher );
void _cdecl DecryptSector ( unsigned long *data , unsigned long secNo , unsigned long noSectors , unsigned char *auxKey , char *iv , int cipher );
...
void _cdecl EncryptSector8 ( unsigned long *data , unsigned long secNo , unsigned long noSectors , unsigned char *ks , char *iv , int cipher );
void _cdecl DecryptSector8 ( unsigned long *data , unsigned long secNo , unsigned long noSectors , unsigned char *ks , char *iv , int cipher );
