...
BOOL WriteSector ( HFILE dev , char *sector , char *write_buf , int *write_buf_cnt , int *nSecNo , int *progress , PCRYPTO_INFO cryptoInfo , int nFrequency );
int Format ( fatparams *ft , HFILE dev , int nVolType , PCRYPTO_INFO cryptoInfo , int nFrequency );
